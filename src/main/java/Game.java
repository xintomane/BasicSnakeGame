public class Game {
    ...
    public static final int DIRECTION_NONE = 0, DIRECTION_RIGHT = 1, DIRECTION_LEFT = 2, DIRECTION_UP = 2, DIRECTION_DOWN = -2;
    ...
    // to update the game at regular intervals, and accept user input from the keyboard
